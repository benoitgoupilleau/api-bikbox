                              ...
                              <tr>
                                <td align="center" valign="top" width="100%">
                                  <table bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:30px;max-width:510px;border-top:5px solid #EB3300;" class="emailContent">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td style="font-family:'Nunito', sans-serif; font-weight:400;line-height:28px;font-size:22px;padding:30px 30px 15px;text-align:left;" class="emailBody">Welcome to Bikbox!</td>
                                      </tr>
                                      <tr>
                                        <td bgcolor="#ffffff" style="font-family:'Nunito', sans-serif; font-size:12px; padding:10px 30px; text-align:left;" align="center" class="emailBody">Hello ${user.firstname} and welcome!</td>
                                      </tr>
                                      <tr>
                                        <td bgcolor="#ffffff" style="font-family:'Nunito', sans-serif; font-size:12px; padding:10px 10px 20px 30px;text-align:left;" align="center" class="emailBody">We are thrilled to see you here. But before anything, please verify your email so we know it's you:</td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        <td bgcolor="#ffffff" style="font-family:'Nunito', sans-serif;font-size:12px;padding:0px 30px;text-align:left;" align="center" class="emailBody"> If you need additional assistance, please contact <a href="mailto:help@bikbox.com" style="font-family:Nunito, sans-serif; color:#FE5000; text-decoration:none;" >help@bikbox.com</a>. <br /> <br /> </td>
                                      </tr>
                                      <tr>
