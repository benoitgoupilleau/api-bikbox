                              ...
                              <tr>
                                <td align="center" valign="top" width="100%">
                                  <table bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:30px;max-width:510px;border-top:5px solid #EB3300;" class="emailContent">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td style="font-family:'Nunito', sans-serif; font-weight:400;line-height:28px;font-size:22px;padding:30px 30px 15px;text-align:left;" class="emailBody">Password updated!</td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        <td bgcolor="#ffffff" style="font-family:'Nunito', sans-serif; font-size:12px; padding:10px 10px 20px 30px;text-align:left;" align="center" class="emailBody">Your password has been updated.</td>
                                      </tr>
                                      <tr>
